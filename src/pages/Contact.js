...
const Contact = () => {
      ...
      emailjs
         ...
         .then(
            ...
            (error) => {
               ...
               toast.error(`Error sending email: ${error.text || 'Please check your configuration.'}`, { position: "top-center" });
            }
         )
         .finally(() => {
            setIsSending(false);
   ...
   return (
      <div className="min-h-screen flex flex-col md:flex-row items-center bg-[#DEEAFE] p-6">
         ...
         <div className="bg-white shadow-lg rounded-lg p-8 m-4 w-full md:w-1/2 flex flex-col justify-between">
