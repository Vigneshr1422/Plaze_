  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 pt-24 flex items-center justify-center">
      <div className="container mx-auto px-4 lg:px-8 space-y-12">
        ...
        <section className="bg-white border border-gray-200 rounded-xl shadow-md p-8 max-w-3xl mx-auto mt-12 hover:shadow-xl transition-shadow duration-300 ease-in-out flex items-center">
          <img 
            src={developerImage} 
            alt="Developer" 
          ...
          />
          <div>
            <h3 className="text-3xl font-semibold text-purple-700 mb-4 text-center md:text-left">About the Developer</h3>
            <p className="text-lg text-gray-600 leading-relaxed">
